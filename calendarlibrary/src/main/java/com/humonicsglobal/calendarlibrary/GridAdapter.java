...
public class GridAdapter extends ArrayAdapter {
    ...
    private CustomCalendarData calendarData;
    private ArrayList<Date> monthlyDates = new ArrayList<>();
    private DateSelectListener listener;
    private LayoutInflater inflater;

    public GridAdapter(@NonNull Context context, @NonNull CustomCalendarData calendarData, @Nullable DateSelectListener listener) {
    ...
    public void updateCalendarData(CustomCalendarData calendarData) {
        this.calendarData = calendarData;
        init();
